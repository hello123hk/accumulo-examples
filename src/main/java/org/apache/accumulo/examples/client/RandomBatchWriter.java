...
public class RandomBatchWriter {
  ...
  public static Mutation createMutation(long rowid, int dataSize, ColumnVisibility visibility) {
    ...
    m.put(new Text("etldr"), new Text("1"), visibility, new Value(value));
    m.put(new Text("etldr"), new Text("2"), visibility, new Value(value));
    m.put(new Text("etldrclean"), new Text("1"), visibility, new Value(value));
    m.put(new Text("emoi"), new Text("1"), visibility, new Value(value));
    m.put(new Text("empi"), new Text("1"), visibility, new Value(value));
    m.put(new Text("schema"), new Text("1"), visibility, new Value(value));
    m.put(new Text("vpid"), new Text("1"), visibility, new Value(value));
    m.put(new Text("etldrnorm"), new Text("1"), visibility, new Value(value));
    m.put(new Text("pp"), new Text("1"), visibility, new Value(value));
    m.put(new Text("soar"), new Text("1"), visibility, new Value(value));
    return m;
  }
  ...
  public static void main(String[] args) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
    ...
    System.out.println(" start insert db : " + start);
